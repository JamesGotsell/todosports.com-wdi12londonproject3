# in a rake task file 
# Todosport is the name of the app and needs to be replaced 
...
#     Todosport::Application.config.non_digest_named_assets
...
namespace :todosports do 
  ...
  task :create_non_digest_assets => :"assets:environment"  do    
    ...
    manifest_data["assets"].each do |logical_path, digested_path|
      ...
      if Todosport::Application.config.non_digest_named_assets.any? {|testpath| logical_pathname.fnmatch?(testpath, File::FNM_PATHNAME) }
